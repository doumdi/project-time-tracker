...
// Import the web preload shim first to set up window.electronAPI
import '../web-preload.js';

// Now import the regular app code
  ...
  return (
    <div className="app">
      <header className="app-header">
        <h1>{t('app.title')} <span style={{fontSize: '0.8em', color: '#ff9800'}}>(DEMO)</span></h1>
